      ...
      >
        ...
        <section className="border-t border-[#E2DDD5]">
          ...
          <ScrollVelocity
            ...
            textClassName="text-xl md:text-[clamp(1.5rem,3vw,2.25rem)] font-bold tracking-[0.05em] text-[#1A1A18] uppercase"
            separatorClassName="text-[#1A1A18]/20 mx-2"
          />
        ...
        <section className="py-28 md:py-52 px-6 md:px-24 border-t border-[#E2DDD5] relative overflow-hidden flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="absolute top-[58%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] md:w-[720px] pointer-events-none select-none">
              <img
